  ...
  answers= [
    { question1: "C", correction: "The ability to launch instances on demand when needed allows users to launch and terminate instances in response to a varying workload. This is a more economical practice than purchasing enough on-premises servers to handle the peak load." },
    { question2: "B", correction: "AWS DMS helps users migrate databases to AWS quickly and securely. The source database remains fully operational during the migration, minimizing downtime to applications that rely on the database. AWS DMS can migrate data to and from most widely used commercial and open-source databases." },
    { question3: "D", correction: "AWS Marketplace is a digital catalog with thousands of software listings from independent software vendors that makes it easy to find, test, buy, and deploy software that runs on AWS." },
    { question4: "D", correction: "Amazon VPC lets users provision a logically isolated section of the AWS Cloud where users can launch AWS resources in a virtual network that they define." },
    { question5: "B", correction: "Maintaining physical hardware is an AWS responsibility under the AWS shared responsibility model." },
    { question6: "B", correction: "To deliver content to users with lower latency, Amazon CloudFront uses a global network of points of presence (edge locations and regional edge caches) worldwide." },
    { question7: "C", correction: "Multi-factor authentication (MFA) is a simple best practice that adds an extra layer of protection on top of a username and password. With MFA enabled, when a user signs in to an AWS Management Console, they will be prompted for their username and password (the first factor—what they know), as well as for an authentication code from their MFA device (the second factor—what they have). Taken together, these multiple factors provide increased security for AWS account settings and resources." },
    { question8: "B", correction: "AWS CloudTrail helps users enable governance, compliance, operational auditing, and risk auditing of their AWS accounts. With CloudTrail, users can log, continuously monitor, and retain account activity related to actions across their AWS infrastructure. This includes actions taken through the AWS Management Console, AWS SDKs, command line tools, and other AWS services. With CloudTrail, users can ensure compliance with internal policies and regulations, such as PCI DSS and HIPAA." },
    { question9: "A", correction: "Amazon Simple Notification Service (Amazon SNS) is a fully managed messaging service that makes it easy to set up, operate, and send notifications from the cloud. Amazon SNS can be used to send messages to a large number of subscribers or other applications as SMS, email, and push notifications to mobile devices. Amazon SNS can be used to send alerts based on Amazon CloudWatch alarms." },
    { question10: "D", correction: "The AWS Acceptable Use Policy outlines prohibited actions on the AWS infrastructure. This policy is designed to help ensure that the AWS infrastructure is used in a manner that is consistent with its intended purpose as a cloud computing platform and to protect the integrity, security, and availability of the AWS infrastructure and the data of AWS customers. It is the responsibility of AWS customers to ensure that their use of the AWS infrastructure complies with the AWS Acceptable Use Policy." }
  ]
